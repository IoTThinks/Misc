...
void processDownlinkMessage(const char* message)
{
  ...
  if(methodName == "setP1")
  {
    ...
    // logHeap();
    char* responseMessage = createUplinkMessage(request_id, "att", "\"p1\":" + params);
...
void updateInternalSensorData()
{
  ...
  CRONJOB_SENSOR_DATA = "\"mb_temp\":" + getModbusSensor(MODBUS_REG_INPUT, 0x0001, 1);
  CRONJOB_SENSOR_DATA += ", \"mb_humid\":" + getModbusSensor(MODBUS_REG_INPUT, 0x0002, 1);
